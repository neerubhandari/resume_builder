  ...
  return (
    <div className="w-full bg-gray-100" id="pdf-content">
      <div className="border border-gray-200 print:shadow-none print:border-none ">
        <div className="max-w-5xl mx-auto  shadow-lg print:shadow-none print:border-none">
          <div className="grid grid-cols-3">
            {/* LEFT SIDEBAR */}
            <div className="col-span-1 bg-blue-600 text-white p-6 space-y-6 print:bg-blue-600 print:[-webkit-print-color-adjust:exact] print:[print-color-adjust:exact]">
              {/* NAME */}
              <div>
